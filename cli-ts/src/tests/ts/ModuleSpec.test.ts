...
const createModuleIdent = (name: string): TsIdentModule => TsIdent.module(none, [name]);
...
describe('ModuleSpec Tests', () => {
  ...
  describe('Addition Operator (+) - Defaulted', () => {
    ...
    test('Defaulted + namespaced identifier', () => {
      const result = ModuleSpec.add(ModuleSpec.defaulted(), TsIdent.namespaced());
  ...
  describe('Addition Operator (+) - Namespaced', () => {
    ...
    test('Namespaced + namespaced identifier', () => {
      const result = ModuleSpec.add(ModuleSpec.namespaced(), TsIdent.namespaced());
  ...
  describe('Addition Operator (+) - Specified', () => {
    ...
    test('Specified + multiple identifiers in sequence', () => {
      ...
      let result: ModuleSpec = ModuleSpec.specified(IArray.apply<TsIdent>(ident1));
      result = ModuleSpec.add(result, ident2);
  ...
  describe('Special Identifier Handling', () => {
    ...
    test('default identifier behavior', () => {
      ...
      const defaultResult = ModuleSpec.add(ModuleSpec.namespaced(), TsIdent.default());
  ...
  describe('Real-World Scenarios', () => {
    ...
    test('complex module path', () => {
      const complexModule = TsIdent.module(some('babel'), ['core', 'lib', 'transform']);
      const helperIdent = createSimpleIdent('helper');

      const result = ModuleSpec.add(ModuleSpec.apply(complexModule), helperIdent);
  ...
  describe('Performance and Memory', () => {
    test('large number of identifiers', () => {
      const identifiers = Array.from({ length: 1000 }, (_, i) => createSimpleIdent(`ident${i + 1}`));
  ...
  describe('Type Guards', () => {
    test('isDefaulted type guard', () => {
      ...
      const specified = ModuleSpec.specified(IArray.apply<TsIdent>(createSimpleIdent('test')));
