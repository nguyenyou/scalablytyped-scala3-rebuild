...
import {TsType, TsTypeRef} from "@/internal/ts/trees.js";
...
describe("InlineConstEnum", () => {
	describe("Basic Functionality", () => {
		it("extends TreeTransformationScopedChanges", () => {
			expect(InlineConstEnum.instance).toBeInstanceOf(TreeTransformationScopedChanges);
		});
		...
		it("leaves type references with insufficient parts unchanged", () => {
			...
			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "SomeType"));
	...
	describe("Const Enum Inlining", () => {
		it("successfully inlines string const enum member", () => {
			const member = createEnumMember("VALUE", some(createLiteralExpr("hello")));
			const constEnum = createMockEnum("StringEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);

			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "StringEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("successfully inlines number const enum member", () => {
			const member = createEnumMember("VALUE", some(createNumLiteralExpr("42")));
			const constEnum = createMockEnum("NumberEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);

			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "NumberEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("successfully inlines boolean const enum member", () => {
			const member = createEnumMember("VALUE", some(createBoolLiteralExpr(true)));
			const constEnum = createMockEnum("BoolEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);

			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "BoolEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("inlines const enum member without expression to union type", () => {
			...
			const constEnum = createMockEnum("DefaultEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);

			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "DefaultEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("ignores non-const enums", () => {
			...
			const regularEnum = createMockEnum("RegularEnum", IArray.fromArray([member]), false); // not const
			const scope = createMockScope("test-lib", regularEnum);

			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "RegularEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
	...
	describe("Edge Cases", () => {
		it("handles non-existent enum member", () => {
			const member = createEnumMember("VALUE", some(createLiteralExpr("test")));
			const constEnum = createMockEnum("TestEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);
			
			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "TestEnum", "NONEXISTENT"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("handles non-existent enum", () => {
			const scope = createMockScope();
			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "NonExistentEnum", "VALUE"));
		...
		it("handles enum with no members", () => {
			...
			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "EmptyEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
		...
		it("handles complex qualified identifiers", () => {
			const member = createEnumMember("VALUE", some(createLiteralExpr("nested")));
			const constEnum = createMockEnum("NestedEnum", IArray.fromArray([member]), true);
			const scope = createMockScope("test-lib", constEnum);
			
			const typeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "namespace", "NestedEnum", "VALUE"));
			const result = InlineConstEnum.instance.enterTsType(scope)(typeRef);
	...
	describe("Integration Scenarios", () => {
		it("handles multiple const enums in scope", () => {
			const enum1Member = createEnumMember("VALUE1", some(createLiteralExpr("first")));
			const enum2Member = createEnumMember("VALUE2", some(createNumLiteralExpr("2")));
			const constEnum1 = createMockEnum("Enum1", IArray.fromArray([enum1Member]), true);
			const constEnum2 = createMockEnum("Enum2", IArray.fromArray([enum2Member]), true);
			const scope = createMockScope("test-lib", constEnum1, constEnum2);

			const typeRef1 = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "Enum1", "VALUE1"));
			const typeRef2 = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "Enum2", "VALUE2"));
		...
		it("handles mixed const and regular enums", () => {
			const constMember = createEnumMember("CONST_VALUE", some(createLiteralExpr("const")));
			const regularMember = createEnumMember("REGULAR_VALUE", some(createLiteralExpr("regular")));
			const constEnum = createMockEnum("ConstEnum", IArray.fromArray([constMember]), true);
			const regularEnum = createMockEnum("RegularEnum", IArray.fromArray([regularMember]), false);
			const scope = createMockScope("test-lib", constEnum, regularEnum);

			const constTypeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "ConstEnum", "CONST_VALUE"));
			const regularTypeRef = createTypeRefWithQIdent(createQIdentFromParts("test-lib", "RegularEnum", "REGULAR_VALUE"));

			const constResult = InlineConstEnum.instance.enterTsType(scope)(constTypeRef);
			const regularResult = InlineConstEnum.instance.enterTsType(scope)(regularTypeRef);
