...
describe('TsTypeUnion Tests', () => {
  ...
  describe('TsTypeUnion.simplified - Nested Union Flattening', () => {
    ...
    it('flattens multiple nested unions', () => {
      ...
      const union1 = TsTypeUnion.create(IArray.fromArray<TsType>([type1, type2]));
      const union2 = TsTypeUnion.create(IArray.fromArray<TsType>([type3, type4]));
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([union1, union2]));
    ...
    it('flattens nested unions with duplicates', () => {
      ...
      const union1 = TsTypeUnion.create(IArray.fromArray<TsType>([stringType, numberType]));
      const union2 = TsTypeUnion.create(IArray.fromArray<TsType>([stringType, numberType]));
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([union1, union2]));
  ...
  describe('Edge Cases and Boundary Conditions', () => {
    it('union with intersection types', () => {
      ...
      const intersectType = TsTypeIntersect.create(IArray.fromArray<TsType>([stringType, numberType]));
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([intersectType, booleanType]));
    ...
    it('union with literal types', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([stringLiteral, numberLiteral, booleanLiteral]));
    ...
    it('union with function types', () => {
      const param = TsFunParam.create(Comments.empty(), TsIdent.simple('x'), some(TsTypeRef.number));
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([functionType, TsTypeRef.string]));
    ...
    it('union with object types', () => {
      ...
      const objectType = TsTypeObject.create(Comments.empty(), IArray.fromArray<TsMember>([prop]));

      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([objectType, TsTypeRef.number]));
    ...
    it('union with never type', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([neverType, stringType]));
    ...
    it('union with any type', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([anyType, stringType]));
    ...
    it('union with undefined and null', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([undefinedType, nullType, stringType]));
  ...
  describe('Type System Integration', () => {
    it('union with type references', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([customType1, customType2]));
    ...
    it('union with generic types', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([genericType1, genericType2]));
    ...
    it('union with tuple types', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([tupleType, TsTypeRef.boolean]));
    ...
    it('union with conditional types', () => {
      ...
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([conditionalType, TsTypeRef.any]));
  ...
  describe('Performance and Scalability', () => {
    ...
    it('deeply nested union flattening', () => {
      ...
      const level1 = TsTypeUnion.create(IArray.fromArray<TsType>([type1, type2]));
      const level2 = TsTypeUnion.create(IArray.fromArray<TsType>([level1, type3]));
      const level3 = TsTypeUnion.create(IArray.fromArray<TsType>([level2, type4]));
      const result = TsTypeUnion.simplified(IArray.fromArray<TsType>([level3, type5]));
  ...
  describe('Equality and HashCode', () => {
    it('equal union types have same hash code', () => {
      const types1 = IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.number]);
      const types2 = IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.number]);
    ...
    it('different union types are not equal', () => {
      const union1 = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.number]));
      const union2 = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.boolean]));
    ...
    it('order matters for equality', () => {
      const union1 = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.number]));
      const union2 = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.number, TsTypeRef.string]));
  ...
  describe('String Representation', () => {
    it('asString contains type information', () => {
      const union = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.string, TsTypeRef.number]));
    ...
    it('single type union asString', () => {
      const union = TsTypeUnion.create(IArray.fromArray<TsType>([TsTypeRef.string]));
      const str = union.asString;
