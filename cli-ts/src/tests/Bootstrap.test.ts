...
describe("Bootstrap", () => {
  ...
  describe("forFolder function", () => {
    ...
    test("should find simple packages", () => {
      ...
      fs.writeFileSync(path.join(lodashDir, "index.d.ts"), "export declare const _: any;");
      fs.writeFileSync(path.join(reactDir, "index.d.ts"), "export declare const React: any;");
      ...
      const libNames = result.map(source => source.libName.value).toArray().sort();
    ...
    test("should handle scoped packages", () => {
      ...
      // Add .d.ts files
      fs.writeFileSync(path.join(angularCoreDir, "index.d.ts"), "export declare const NgModule: any;");
      fs.writeFileSync(path.join(angularCommonDir, "index.d.ts"), "export declare const CommonModule: any;");
    ...
    test("should skip @types directories", () => {
      ...
      fs.writeFileSync(path.join(typesNodeDir, "index.d.ts"), "export declare const process: any;");
    ...
    test("should skip packages without TypeScript sources", () => {
      ...
      fs.writeFileSync(path.join(packageWithoutTypes, "index.js"), "module.exports = {};");
      ...
      fs.writeFileSync(path.join(packageWithTypes, "index.d.ts"), "export declare const test: any;");
