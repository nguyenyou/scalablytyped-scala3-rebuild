...
import { Selection, AllExcept, NoneExcept, And, Or } from '../internal/Selection.js';
...
describe('Selection', () => {
  ...
  describe('JSON Serialization and Deserialization', () => {
    ...
    test('Invalid JSON format', () => {
      ...
      expect(() => Selection.fromJSON<string>(invalidJson)).toThrow('Invalid Selection format');
    });
  ...
  describe('Error Handling and Robustness', () => {
    ...
    test('very large selections', () => {
      const largeArray = Array.from({ length: 1000 }, (_, i) => (i + 1).toString());
    ...
    test('JSON serialization with complex types', () => {
      ...
      const obj1: ComplexType = { id: 1, name: 'test1', nested: { value: 'nested1' } };
      const obj2: ComplexType = { id: 2, name: 'test2', nested: { value: 'nested2' } };
