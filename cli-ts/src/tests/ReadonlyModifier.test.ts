...
describe('ReadonlyModifier', () => {
  ...
  describe('combine functionality', () => {
    it('should return first modifier when second is Noop', () => {
      ...
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(yes, noop), yes)).toBe(true);
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(no, noop), no)).toBe(true);
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(noop, noop), noop)).toBe(true);
    });
    ...
    it('should return second modifier when second is not Noop', () => {
      ...
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(noop, yes), yes)).toBe(true);
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(noop, no), no)).toBe(true);
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(yes, no), no)).toBe(true);
      expect(ReadonlyModifier.equals(ReadonlyModifier.combine(no, yes), yes)).toBe(true);
    });
  });
