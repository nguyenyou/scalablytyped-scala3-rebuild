...
describe("PathsFromTsLibSource Tests", () => {
  ...
  function withTempDir<T>(testName: string, test: (tempDir: string) => T): T {
    const tempDir = fs.mkdtempSync(path.join(os.tmpdir(), `paths-from-ts-lib-source-test-${testName}-`));
    try {
      return test(tempDir);
    } finally {
  ...
  describe("filesFrom method", () => {
    ...
    test("should find .d.ts files in root directory", () => {
      withTempDir("root-dts", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const test: string;");
        createTestFile(path.join(tempDir, "types.d.ts"), "export interface TestInterface {}");
        createTestFile(path.join(tempDir, "utils.d.ts"), "export declare function util(): void;");
        ...
        const filePaths = result.map(file => file.path).toArray().sort();
    ...
    test("should find .d.ts files in subdirectories", () => {
      withTempDir("subdirs", (tempDir) => {
        createTestFile(path.join(tempDir, "src", "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "lib", "utils.d.ts"), "export declare function helper(): void;");
        createTestFile(path.join(tempDir, "types", "interfaces.d.ts"), "export interface Config {}");
    ...
    test("should ignore non-.d.ts files", () => {
      withTempDir("mixed-files", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const test: string;");
        createTestFile(path.join(tempDir, "index.ts"), "export const test = 'value';");
        createTestFile(path.join(tempDir, "index.js"), "export const test = 'value';");
    ...
    test("should skip node_modules directories", () => {
      withTempDir("node-modules", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "node_modules", "lodash", "index.d.ts"), "export declare const _: any;");
        createTestFile(path.join(tempDir, "node_modules", "react", "index.d.ts"), "export declare const React: any;");
    ...
    test("should skip amd directories", () => {
      withTempDir("amd", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "amd", "module.d.ts"), "declare module 'amd-module' {}");
        createTestFile(path.join(tempDir, "normal", "file.d.ts"), "export declare const normal: string;");
        ...
        const filePaths = result.map(file => file.path).toArray().sort();
        expect(filePaths.some(p => p.endsWith("index.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.endsWith("normal/file.d.ts") || p.endsWith("normal\\file.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("/amd/") || p.includes("\\amd\\"))).toBe(false);
      });
    });
    ...
    test("should skip umd directories", () => {
      withTempDir("umd", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "umd", "module.d.ts"), "declare module 'umd-module' {}");
        createTestFile(path.join(tempDir, "normal", "file.d.ts"), "export declare const normal: string;");
        ...
        expect(filePaths.some(p => p.endsWith("index.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.endsWith("normal/file.d.ts") || p.endsWith("normal\\file.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("/umd/") || p.includes("\\umd\\"))).toBe(false);
      });
    });
    ...
    test("should skip es directories", () => {
      withTempDir("es", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "es", "module.d.ts"), "declare module 'es-module' {}");
        createTestFile(path.join(tempDir, "normal", "file.d.ts"), "export declare const normal: string;");
        ...
        expect(filePaths.some(p => p.endsWith("index.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.endsWith("normal/file.d.ts") || p.endsWith("normal\\file.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("/es/") || p.includes("\\es\\"))).toBe(false);
      });
    });
    ...
    test("should skip es6 directories", () => {
      withTempDir("es6", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "es6", "module.d.ts"), "declare module 'es6-module' {}");
        createTestFile(path.join(tempDir, "normal", "file.d.ts"), "export declare const normal: string;");
        ...
        expect(filePaths.some(p => p.endsWith("index.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.endsWith("normal/file.d.ts") || p.endsWith("normal\\file.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("/es6/") || p.includes("\\es6\\"))).toBe(false);
      });
    });
    test("should skip TypeScript version directories (ts pattern)", () => {
      withTempDir("ts-version", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "ts3.8", "module.d.ts"), "declare module 'ts38-module' {}");
        createTestFile(path.join(tempDir, "ts4.0", "module.d.ts"), "declare module 'ts40-module' {}");
        createTestFile(path.join(tempDir, "ts4.5.2", "module.d.ts"), "declare module 'ts452-module' {}");
    ...
    test("should skip version directories (v pattern)", () => {
      withTempDir("version", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "v1.0", "module.d.ts"), "declare module 'v1-module' {}");
        createTestFile(path.join(tempDir, "v2.5.1", "module.d.ts"), "declare module 'v2-module' {}");
        createTestFile(path.join(tempDir, "v10.15.3", "module.d.ts"), "declare module 'v10-module' {}");
    ...
    test("should filter out .src. files", () => {
      withTempDir("src-files", (tempDir) => {
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "highlight.src.d.ts"), "declare module 'highlight-src' {}");
        createTestFile(path.join(tempDir, "utils.src.d.ts"), "declare module 'utils-src' {}");
        createTestFile(path.join(tempDir, "normal.d.ts"), "export declare const normal: string;");
    ...
    test("should handle complex directory structure with multiple skip patterns", () => {
      withTempDir("complex", (tempDir) => {
        // Valid files
        createTestFile(path.join(tempDir, "index.d.ts"), "export declare const main: string;");
        createTestFile(path.join(tempDir, "src", "types.d.ts"), "export interface Config {}");
        createTestFile(path.join(tempDir, "lib", "utils.d.ts"), "export declare function helper(): void;");
        ...
        createTestFile(path.join(tempDir, "es6", "module.d.ts"), "declare module 'es6-module' {}");
        createTestFile(path.join(tempDir, "ts4.0", "module.d.ts"), "declare module 'ts40-module' {}");
        createTestFile(path.join(tempDir, "v2.0", "module.d.ts"), "declare module 'v2-module' {}");
        createTestFile(path.join(tempDir, "highlight.src.d.ts"), "declare module 'highlight-src' {}");
        ...
        expect(filePaths.every(p => p.endsWith(".d.ts"))).toBe(true);
        expect(filePaths.some(p => p.endsWith("index.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("src") && p.endsWith("types.d.ts"))).toBe(true);
        expect(filePaths.some(p => p.includes("lib") && p.endsWith("utils.d.ts"))).toBe(true);
        ...
        expect(filePaths.some(p => p.includes("/es/") || p.includes("\\es\\"))).toBe(false);
        expect(filePaths.some(p => p.includes("/es6/") || p.includes("\\es6\\"))).toBe(false);
        expect(filePaths.some(p => p.includes("/ts4.0/") || p.includes("\\ts4.0\\"))).toBe(false);
        expect(filePaths.some(p => p.includes("/v2.0/") || p.includes("\\v2.0\\"))).toBe(false);
        expect(filePaths.some(p => p.includes(".src."))).toBe(false);
      });
    });
    ...
    test("should return InFile instances with correct paths", () => {
      withTempDir("infile-paths", (tempDir) => {
        createTestFile(path.join(tempDir, "test.d.ts"), "export declare const test: string;");
    ...
    test("should handle deeply nested directory structures", () => {
      withTempDir("deep-nested", (tempDir) => {
        ...
        createTestFile(path.join(deepPath1, "deep.d.ts"), "export declare const deep: string;");
        createTestFile(path.join(deepPath2, "nested.d.ts"), "export declare const nested: string;");
  ...
  describe("Edge cases and boundary conditions", () => {
    test("should handle directory with only non-.d.ts files", () => {
      withTempDir("no-dts", (tempDir) => {
        createTestFile(path.join(tempDir, "index.ts"), "export const test = 'value';");
        createTestFile(path.join(tempDir, "utils.js"), "export const util = () => {};");
    ...
    test("should handle directory with only skipped subdirectories", () => {
      withTempDir("only-skipped", (tempDir) => {
        createTestFile(path.join(tempDir, "node_modules", "test", "index.d.ts"), "export declare const test: string;");
        createTestFile(path.join(tempDir, "amd", "module.d.ts"), "declare module 'amd' {}");
        createTestFile(path.join(tempDir, "v1.0", "old.d.ts"), "export declare const old: string;");
    ...
    test("should handle directory with only .src. files", () => {
      withTempDir("only-src", (tempDir) => {
        createTestFile(path.join(tempDir, "highlight.src.d.ts"), "declare module 'highlight' {}");
        createTestFile(path.join(tempDir, "utils.src.d.ts"), "declare module 'utils' {}");
        createTestFile(path.join(tempDir, "main.src.d.ts"), "declare module 'main' {}");
    ...
    test("should handle files with .d.ts in the middle of filename", () => {
      withTempDir("dts-middle", (tempDir) => {
        ...
        createTestFile(path.join(tempDir, "valid.d.ts"), "export declare const valid: string;");
    ...
    test("should handle symbolic links and special files", () => {
      withTempDir("special-files", (tempDir) => {
        ...
        createTestFile(path.join(tempDir, "fake-file.d.ts", "content.txt"), "not a .d.ts file");
    ...
    test("should handle very long file paths", () => {
      withTempDir("long-paths", (tempDir) => {
        const longPathSegments = Array.from({length: 10}, (_, i) => `very-long-directory-name-${i + 1}`);
        const longPath = path.join(tempDir, ...longPathSegments);
        createTestFile(path.join(longPath, "deep.d.ts"), "export declare const deep: string;");
    ...
    test("should handle files with special characters in names", () => {
      withTempDir("special-chars", (tempDir) => {
        createTestFile(path.join(tempDir, "test-file.d.ts"), "export declare const test: string;");
        createTestFile(path.join(tempDir, "test_file.d.ts"), "export declare const test2: string;");
        createTestFile(path.join(tempDir, "test.file.d.ts"), "export declare const test3: string;");
        createTestFile(path.join(tempDir, "test@file.d.ts"), "export declare const test4: string;");
    ...
    test("should handle file extension case sensitivity correctly", () => {
      withTempDir("case-sensitive", (tempDir) => {
        createTestFile(path.join(tempDir, "Test.d.ts"), "export declare const Test: string;");
        createTestFile(path.join(tempDir, "another.d.ts"), "export declare const another: string;");
        createTestFile(path.join(tempDir, "wrongext.D.TS"), "not a valid .d.ts file");
    ...
    test("should handle mixed skip patterns in same directory tree", () => {
      withTempDir("mixed-skip", (tempDir) => {
        createTestFile(path.join(tempDir, "valid.d.ts"), "export declare const valid: string;");
        createTestFile(path.join(tempDir, "node_modules", "v1.0", "test.d.ts"), "should be skipped");
        createTestFile(path.join(tempDir, "amd", "ts4.0", "test.d.ts"), "should be skipped");
        createTestFile(path.join(tempDir, "es", "umd", "test.d.ts"), "should be skipped");
        createTestFile(path.join(tempDir, "normal", "es6", "test.d.ts"), "should be skipped");
  ...
  describe("Performance and stress tests", () => {
    test("should handle large number of files efficiently", () => {
      withTempDir("many-files", (tempDir) => {
        ...
        for (let i = 1; i <= 100; i++) {
          createTestFile(path.join(tempDir, `file${i}.d.ts`), `export declare const file${i}: string;`);
        }
        ...
        const fileNumbers = result.toArray()
          .map(file => file.path)
    ...
    test("should handle deep directory nesting efficiently", () => {
      withTempDir("deep-nesting", (tempDir) => {
        ...
        const deepPathSegments = Array.from({length: 20}, (_, i) => `level${i + 1}`);
        const deepPath = path.join(tempDir, ...deepPathSegments);
        createTestFile(path.join(deepPath, "deep.d.ts"), "export declare const deep: string;");
