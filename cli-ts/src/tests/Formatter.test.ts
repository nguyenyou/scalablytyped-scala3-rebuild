...
describe('Formatter Tests', () => {
  ...
  describe('Tuple Formatters', () => {
    ...
    test('Tuple3 formatter should join with commas', () => {
      const formatter = tuple3Formatter(stringFormatter, stringFormatter, stringFormatter);
    ...
    test('Tuple4 formatter should join with commas', () => {
      const formatter = tuple4Formatter(stringFormatter, stringFormatter, stringFormatter, stringFormatter);
      const input: [string, string, string, string] = ["first", "second", "third", "fourth"];
      const result = formatter.apply(input);
    ...
    test('Mixed type tuples should format correctly', () => {
      const formatter = tuple3Formatter(stringFormatter, numberFormatter, unitFormatter);
  ...
  describe('Either Formatter', () => {
    ...
    test('Nested Either should format correctly', () => {
      ...
      const input: E.Either<E.Either<string, number>, string> = E.left(E.right(123));
      const result = outerFormatter.apply(input);
  ...
  describe('Map Formatter', () => {
    ...
    test('Map with different types should format correctly', () => {
      ...
      const input = new Map([["count", 42], ["index", 0]]);
      const result = formatter.apply(input);
      expect(result.includes(" => ")).toBe(true);
  ...
  describe('Edge Cases and Complex Scenarios', () => {
    ...
    test('Complex nested structure should format correctly', () => {
      ...
      const tupleResult = tuple2Formatter(stringFormatter, stringFormatter).apply(tupleInput);
      const eitherResult = eitherFormatter(stringFormatter, numberFormatter).apply(eitherInput);
    ...
    test('URI with query parameters should format correctly', () => {
      const uri = new URL("https://example.com/path?param1=value1&param2=value2");
      const result = uriFormatter.apply(uri);
    ...
    test('Mixed collection types should format correctly', () => {
      ...
      const arrayResult = arrayFormatter(stringFormatter).apply(mixedData[2] as string[]);
