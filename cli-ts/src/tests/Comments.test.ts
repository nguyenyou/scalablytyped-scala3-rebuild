...
import { Comment, Raw, Marker, NameHint, IsTrivial } from '../internal/Comment.js';
import { Comments, NoComments, CommentsEncoder, CommentsDecoder } from '../internal/Comments.js';
...
describe('Comments', () => {
  ...
  describe('Edge cases and error handling', () => {
    ...
    it('should handle large comment collections efficiently', () => {
      const largeCommentArray = Array.from({ length: 1000 }, (_, i) => new Raw(`comment-${i}`));
