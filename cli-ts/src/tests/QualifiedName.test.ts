...
describe('QualifiedName', () => {
  ...
  test('should support utility functions', () => {
    expect(QualifiedName.AnyFromFunction(2).value).toBe('scala.scalajs.js.Any.fromFunction2');
    expect(QualifiedName.Instantiable(3).value).toBe('org.scalablytyped.runtime.Instantiable3');
