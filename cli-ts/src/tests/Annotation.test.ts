...
import { Annotation, Imported, AnnotationUnion } from '../internal/scalajs/Annotation.js';
...
describe('Annotation', () => {
  ...
  describe('Complex annotations', () => {
    ...
    test('should create JsGlobal annotation', () => {
      const qname = new QualifiedName(IArray.fromArray([new Name('global'), new Name('test')]));
  ...
  describe('Imported types', () => {
    ...
    test('should create Named import', () => {
      const names = IArray.fromArray([new Name('Component'), new Name('useState')]);
  ...
  describe('renamedFrom function', () => {
    ...
    test('should preserve existing name annotations', () => {
      ...
      const oldAnnotations = IArray.fromArray<AnnotationUnion>([existingAnnotation, otherAnnotation]);
  ...
  describe('Utility functions', () => {
    test('should detect location annotations', () => {
      const annotations = IArray.fromArray<AnnotationUnion>([
        ...
        Annotation.JsGlobal(new QualifiedName(IArray.fromArray([new Name('test')])))
      ]);
      
      expect(Annotation.hasLocationAnnotation(annotations)).toBe(true);
      
      const locationAnnotations = Annotation.getLocationAnnotations(annotations);
    ...
    test('should extract specific annotation types', () => {
      ...
      const jsGlobal = Annotation.JsGlobal(new QualifiedName(IArray.fromArray([new Name('global')])));
