...
export const TsProtectionLevel = {
   ...
   */
  isDefault: (protectionLevel: TsProtectionLevel): protectionLevel is Default => {
   ...
   */
  isPrivate: (protectionLevel: TsProtectionLevel): protectionLevel is Private => {
   ...
   */
  isProtected: (protectionLevel: TsProtectionLevel): protectionLevel is Protected => {
  ...
  isAccessible: (protectionLevel: TsProtectionLevel): boolean => {
    return TsProtectionLevel.isDefault(protectionLevel) || TsProtectionLevel.isProtected(protectionLevel);
  },
  ...
  isRestricted: (protectionLevel: TsProtectionLevel): boolean => {
    return TsProtectionLevel.isPrivate(protectionLevel) || TsProtectionLevel.isProtected(protectionLevel);
  },
  ...
  get all(): TsProtectionLevel[] {
    return [TsProtectionLevel.default(), TsProtectionLevel.private(), TsProtectionLevel.protected()];
  },
