...
import { CodePath, type HasCodePath } from "./CodePath.js";
import type { Directive } from "./Directive.js";
import { ExportType } from "./ExportType.js";
import { type HasJsLocation, JsLocation } from "./JsLocation.js";
import { HasClassMembers, MemberCache } from "./MemberCache.js";
 ...
 */
export interface TsDeclNamespaceOrModule
	extends TsContainer,
		TsNamedValueDecl,
		HasJsLocation {}
 ...
 */
export interface TsDeclFunction
	extends TsNamedValueDecl,
		HasJsLocation,
		TsNamedDecl {
...
export const TsIdent = {
	 ...
	 * Type guards
	 */
	isSimple: (ident: TsIdent): ident is TsIdentSimple =>
		ident._tag === "TsIdentSimple",
	isImport: (ident: TsIdent): ident is TsIdentImport =>
		ident._tag === "TsIdentImport",
	isModule: (ident: TsIdent): ident is TsIdentModule =>
		ident._tag === "TsIdentModule",
	isLibrarySimple: (ident: TsIdent): ident is TsIdentLibrarySimple =>
		ident._tag === "TsIdentLibrarySimple",
	isLibraryScoped: (ident: TsIdent): ident is TsIdentLibraryScoped =>
...
export const TsIdentLibrary = {
	 ...
	 * Type guards
	 */
	isSimple: (lib: TsIdentLibrary): lib is TsIdentLibrarySimple =>
		lib._tag === "TsIdentLibrarySimple",
	isScoped: (lib: TsIdentLibrary): lib is TsIdentLibraryScoped =>
		lib._tag === "TsIdentLibraryScoped",
};
...
export const TsIdentModule = {
	...
	inLibrary: (module: TsIdentModule): TsIdentLibrary => {
		if (module.scopeOpt._tag === "None") {
			...
			return TsIdent.libraryScoped(
				module.scopeOpt.value,
				module.fragments[0] || "",
			);
		}
	},
...
export const TsIdentDestructured: TsIdentSimple =
	TsIdent.simple("<destructured>");
...
export const TsIdentDummyLibrary: TsIdentLibrary =
	TsIdent.librarySimple("dummyLibrary");
...
export const TsQIdent = {
	...
	append: (qident: TsQIdent, ident: TsIdent): TsQIdent => ({
		...
		asString: `TsQIdent(${qident.parts
			.toArray()
			.concat([ident])
			.map((p) => p.value)
			.join(".")})`,
...
export const TsQIdentReadonlyArray: TsQIdent =
	TsQIdent.ofStrings("ReadonlyArray");

/** The `Boolean` constructor type */
export const TsQIdentBooleanConstructor: TsQIdent =
	TsQIdent.ofStrings("Boolean");
...
export const TsLiteral = {
	 ...
	 * Type guards
	 */
	isStr: (literal: TsLiteral): literal is TsLiteralStr =>
		literal._tag === "TsLiteralStr",
	isNum: (literal: TsLiteral): literal is TsLiteralNum =>
		literal._tag === "TsLiteralNum",
	isBool: (literal: TsLiteral): literal is TsLiteralBool =>
		literal._tag === "TsLiteralBool",
};
...
export const TsParsedFile = {
	...
	create: (
		...
		const isStdLib = directives
			.toArray()
			.some((directive) => directive._tag === "NoStdLib");
	 ...
	 * Type guard
	 */
	isParsedFile: (tree: TsTree): tree is TsParsedFile =>
...
export const TsDeclNamespace = {
	 ...
	 * Type guard
	 */
	isNamespace: (tree: TsTree): tree is TsDeclNamespace =>
...
export const TsDeclModule = {
	 ...
	 * Type guard
	 */
	isModule: (tree: TsTree): tree is TsDeclModule =>
...
export const TsAugmentedModule = {
	 ...
	 * Type guard
	 */
	isAugmentedModule: (tree: TsTree): tree is TsAugmentedModule =>
		tree._tag === "TsAugmentedModule",
};
...
export const TsDeclInterface = {
	 ...
	 * Type guard
	 */
	isInterface: (tree: TsTree): tree is TsDeclInterface =>
...
export const TsDeclEnum = {
	...
	simple: (name: TsIdentSimple, members: IArray<TsEnumMember>): TsDeclEnum =>
		TsDeclEnum.create(
			...
			CodePath.hasPath(
				TsIdent.simple("lib"),
				TsQIdent.of(TsIdent.simple("lib"), name),
			),
		),
...
export const TsDeclFunction = {
	 ...
	 * Type guard
	 */
	isFunction: (tree: TsTree): tree is TsDeclFunction =>
...
export const TsDeclTypeAlias = {
	 ...
	 * Type guard
	 */
	isTypeAlias: (tree: TsTree): tree is TsDeclTypeAlias =>
...
export const TsTypeParam = {
	 ...
	 * Type guard
	 */
	isTypeParam: (tree: TsTree): tree is TsTypeParam =>
		tree._tag === "TsTypeParam",
};
...
export const TsFunSig = {
	...
	withTypeParams: (
		...
		params: IArray<TsFunParam>,
		resultType: Option<TsType>,
	): TsFunSig => TsFunSig.create(Comments.empty(), tparams, params, resultType),
...
export const TsFunParam = {
	...
	create: (
		...
		return {
			...
			name,
			tpe,
			withComments: (cs: Comments) => TsFunParam.create(cs, name, tpe),
			addComment: (c: Comment) => TsFunParam.create(comments.add(c), name, tpe),
	...
	withComments: (
		...
		name: TsIdentSimple,
		tpe: Option<TsType>,
	): TsFunParam => TsFunParam.create(comments, name, tpe),
...
export const TsTypeRef = {
	...
	create: (
		...
		return {
			...
			name,
			tparams,
			withComments: (cs: Comments) => TsTypeRef.create(cs, name, tparams),
			addComment: (c: Comment) =>
	...
	get any(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentAny, IArray.Empty);
	},
	get boolean(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentBoolean, IArray.Empty);
	},
	get Boolean(): TsTypeRef {
		return TsTypeRef.create(
			Comments.empty(),
			TsQIdentBooleanConstructor,
			IArray.Empty,
		);
	},
	get symbol(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentSymbol, IArray.Empty);
	},
	get object(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentObject, IArray.Empty);
	},
	get Object(): TsTypeRef {
		return TsTypeRef.create(
			Comments.empty(),
			TsQIdentObjectConstructor,
			IArray.Empty,
		);
	},
	get string(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentString, IArray.Empty);
	},
	get String(): TsTypeRef {
		return TsTypeRef.create(
			Comments.empty(),
			TsQIdentStringConstructor,
			IArray.Empty,
		);
	},
	get never(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentNever, IArray.Empty);
	},
	get number(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentNumber, IArray.Empty);
	},
	get null(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentNull, IArray.Empty);
	},
	get void(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentVoid, IArray.Empty);
	},
	get undefined(): TsTypeRef {
		return TsTypeRef.create(Comments.empty(), TsQIdentUndefined, IArray.Empty);
	},
...
export const TsTypeLiteral = {
	 ...
	 * Type guard
	 */
	isTypeLiteral: (tree: TsTree): tree is TsTypeLiteral =>
		tree._tag === "TsTypeLiteral",
};
...
export const TsTypeObject = {
	 ...
	 */
	create: (comments: Comments, members: IArray<TsMember>): TsTypeObject => {
		// Create class member cache
		const classMemberCache = HasClassMembers.create(members);
		...
		return {
			...
			comments,
			...classMemberCache,
			withComments: (cs: Comments) => TsTypeObject.create(cs, members),
			addComment: (c: Comment) => TsTypeObject.create(comments.add(c), members),
	 ...
	 * Type guard
	 */
	isTypeObject: (tree: TsTree): tree is TsTypeObject =>
		tree._tag === "TsTypeObject",
};
...
export const TsTypeFunction = {
	 ...
	 * Type guard
	 */
	isTypeFunction: (tree: TsTree): tree is TsTypeFunction =>
		tree._tag === "TsTypeFunction",
};
...
export const TsTypeUnion = {
	...
	simplified: (types: IArray<TsType>): TsType => {
		...
		const distinct = IArray.fromArray(
			[...new Set(flattened.toArray().map((t) => t.asString))].map(
				(str) => flattened.toArray().find((t) => t.asString === str)!,
			),
		);
	 ...
	 * Type guard
	 */
	isTypeUnion: (tree: TsTree): tree is TsTypeUnion =>
		tree._tag === "TsTypeUnion",
};
...
export const TsTypeIntersect = {
	...
	areLogicallyEqual: (type1: TsType, type2: TsType): boolean => {
		...
		if (type1._tag === "TsTypeRef" && type2._tag === "TsTypeRef") {
			...
			for (let i = 0; i < ref1.tparams.length; i++) {
				if (
					!TsTypeIntersect.areLogicallyEqual(
						ref1.tparams.apply(i),
						ref2.tparams.apply(i),
					)
				) {
					return false;
				}
	...
	simplified: (types: IArray<TsType>): TsType => {
		...
		for (let i = 0; i < types.length; i++) {
			const type = types.apply(i);
			if (
				type._tag === "TsTypeObject" &&
				!TsType.isTypeMapping((type as TsTypeObject).members)
			) {
	 ...
	 * Type guard
	 */
	isTypeIntersect: (tree: TsTree): tree is TsTypeIntersect =>
		tree._tag === "TsTypeIntersect",
};
...
export const TsMemberCall = {
	...
	create: (
		...
		return {
			...
			level,
			signature,
			withComments: (cs: Comments) => TsMemberCall.create(cs, level, signature),
			addComment: (c: Comment) =>
	 ...
	 * Type guard
	 */
	isMemberCall: (tree: TsTree): tree is TsMemberCall =>
		tree._tag === "TsMemberCall",
};
...
export const TsMemberCtor = {
	...
	create: (
		...
		return {
			...
			level,
			signature,
			withComments: (cs: Comments) => TsMemberCtor.create(cs, level, signature),
			addComment: (c: Comment) =>
	 ...
	 * Type guard
	 */
	isMemberCtor: (tree: TsTree): tree is TsMemberCtor =>
		tree._tag === "TsMemberCtor",
};
...
export const TsMemberFunction = {
	 ...
	 * Type guard
	 */
	isMemberFunction: (tree: TsTree): tree is TsMemberFunction =>
		tree._tag === "TsMemberFunction",
};
...
export const IndexingDict = {
	 ...
	 * Type guard
	 */
	isIndexingDict: (tree: TsTree): tree is IndexingDict =>
		tree._tag === "IndexingDict",
};
...
export const IndexingSingle = {
	 ...
	 * Type guard
	 */
	isIndexingSingle: (tree: TsTree): tree is IndexingSingle =>
		tree._tag === "IndexingSingle",
};
...
export const TsMemberIndex = {
	 ...
	 * Type guard
	 */
	isMemberIndex: (tree: TsTree): tree is TsMemberIndex =>
		tree._tag === "TsMemberIndex",
};
...
export const TsMemberProperty = {
	 ...
	 * Type guard
	 */
	isMemberProperty: (tree: TsTree): tree is TsMemberProperty =>
		tree._tag === "TsMemberProperty",
};
...
export const TsImportedIdent = {
	 ...
	 * Type guard
	 */
	isImportedIdent: (tree: TsTree): tree is TsImportedIdent =>
		tree._tag === "TsImportedIdent",
};
...
export const TsImportedDestructured = {
	...
	simple: (idents: IArray<TsIdent>): TsImportedDestructured => {
		const pairs = idents.map(
			(ident) => [ident, none] as [TsIdent, Option<TsIdentSimple>],
		);
	 ...
	 * Type guard
	 */
	isImportedDestructured: (tree: TsTree): tree is TsImportedDestructured =>
		tree._tag === "TsImportedDestructured",
};
...
export const TsImportedStar = {
	 ...
	 */
	withoutAlias: (): TsImportedStar => TsImportedStar.create(none),

	/**
	 * Type guard
	 */
	isImportedStar: (tree: TsTree): tree is TsImportedStar =>
		tree._tag === "TsImportedStar",
};
...
export const TsImporteeRequired = {
	 ...
	 * Type guard
	 */
	isImporteeRequired: (tree: TsTree): tree is TsImporteeRequired =>
		tree._tag === "TsImporteeRequired",
};
...
export const TsImporteeFrom = {
	 ...
	 * Type guard
	 */
	isImporteeFrom: (tree: TsTree): tree is TsImporteeFrom =>
		tree._tag === "TsImporteeFrom",
};
...
export const TsImporteeLocal = {
	 ...
	 * Type guard
	 */
	isImporteeLocal: (tree: TsTree): tree is TsImporteeLocal =>
		tree._tag === "TsImporteeLocal",
};
...
export const TsImport = {
	...
	named: (names: IArray<TsIdent>, from: TsIdentModule): TsImport => {
		const imported = IArray.fromArray([
			TsImportedDestructured.simple(names),
		] as TsImported[]);
...
export const TsExporteeNames = {
	...
	simple: (idents: IArray<TsQIdent>): TsExporteeNames => {
		const pairs = idents.map(
			(ident) => [ident, none] as [TsQIdent, Option<TsIdentSimple>],
		);
	 ...
	 * Type guard
	 */
	isExporteeNames: (tree: TsTree): tree is TsExporteeNames =>
		tree._tag === "TsExporteeNames",
};
...
export const TsExporteeTree = {
	 ...
	 * Type guard
	 */
	isExporteeTree: (tree: TsTree): tree is TsExporteeTree =>
		tree._tag === "TsExporteeTree",
};
...
export const TsExporteeStar = {
	 ...
	 * Type guard
	 */
	isExporteeStar: (tree: TsTree): tree is TsExporteeStar =>
		tree._tag === "TsExporteeStar",
};
...
export const TsExport = {
	...
	withComments: (
		...
		tpe: ExportType,
		exported: TsExportee,
	): TsExport => TsExport.create(comments, typeOnly, tpe, exported),
...
export const TsExprLiteral = {
	 ...
	 * Type guard
	 */
	isExprLiteral: (tree: TsTree): tree is TsExprLiteral =>
		tree._tag === "TsExprLiteral",
};
...
export const TsExprCall = {
	 ...
	 */
	noParams: (func: TsExpr): TsExprCall => TsExprCall.create(func, IArray.Empty),
	...
	method: (
		obj: TsExpr,
		methodName: string,
		params: IArray<TsExpr>,
	): TsExprCall => {
		const objQIdent =
			obj._tag === "TsExprRef"
				? (obj as TsExprRef).value
				: TsQIdent.ofStrings("obj");
...
export const TsExprUnary = {
	 ...
	 */
	not: (expr: TsExpr): TsExprUnary => TsExprUnary.create("!", expr),

	/**
	 * Creates a numeric negation expression
	 */
	negate: (expr: TsExpr): TsExprUnary => TsExprUnary.create("-", expr),

	/**
	 * Creates a typeof expression
	 */
	typeof: (expr: TsExpr): TsExprUnary => TsExprUnary.create("typeof", expr),

	/**
	 * Creates a void expression
	 */
	void: (expr: TsExpr): TsExprUnary => TsExprUnary.create("void", expr),

	/**
	 * Type guard
	 */
	isExprUnary: (tree: TsTree): tree is TsExprUnary =>
		tree._tag === "TsExprUnary",
};
...
export const TsExprBinaryOp = {
	 ...
	 * Type guard
	 */
	isExprBinaryOp: (tree: TsTree): tree is TsExprBinaryOp =>
		tree._tag === "TsExprBinaryOp",
};
...
export const TsExprCast = {
	 ...
	 */
	toAny: (expr: TsExpr): TsExprCast => TsExprCast.create(expr, TsTypeRef.any),
...
export const TsExprArrayOf = {
	 ...
	 */
	single: (element: TsExpr): TsExprArrayOf => TsExprArrayOf.create(element),

	/**
	 * Type guard
	 */
	isExprArrayOf: (tree: TsTree): tree is TsExprArrayOf =>
		tree._tag === "TsExprArrayOf",
};
...
export const TsExpr = {
	 ...
	 */
	Default: TsTypeUnion.simplified(
	...
	format: (expr: TsExpr): string => {
		switch (expr._tag) {
			...
			case "TsExprCall": {
				...
				const paramStrs = callExpr.params
					.map(TsExpr.format)
					.toArray()
					.join(", ");
		...
		switch (expr._tag) {
			...
			case "TsExprBinaryOp": {
				...
				if (leftNum !== undefined && rightNum !== undefined) {
					if (binaryExpr.op === "+") {
						return TsTypeLiteral.create(
							TsLiteral.num((leftNum + rightNum).toString()),
						);
				...
				if (leftLong !== undefined && rightLong !== undefined) {
					if (binaryExpr.op === "<<") {
						return TsTypeLiteral.create(
							TsLiteral.num((leftLong << rightLong).toString()),
						);
					} else if (binaryExpr.op === ">>") {
						return TsTypeLiteral.create(
							TsLiteral.num((leftLong >> rightLong).toString()),
	...
	typeOfOpt: (exprOpt: Option<TsExpr>): TsType => {
		return exprOpt._tag === "Some"
			? TsExpr.typeOf(exprOpt.value)
			: TsExpr.Default;
	},
	...
	isNumericLiteral: (tpe: TsType): boolean => {
		return (
			tpe._tag === "TsTypeLiteral" &&
			TsLiteral.isNum((tpe as TsTypeLiteral).literal)
		);
	},
	...
	visit: (expr: TsExpr, f: (e: TsExpr) => TsExpr): TsExpr => {
		const transformed = (() => {
			switch (expr._tag) {
				...
				case "TsExprCast": {
					const castExpr = expr as TsExprCast;
					return TsExprCast.create(
						TsExpr.visit(castExpr.expr, f),
						castExpr.tpe,
					);
				}
				case "TsExprArrayOf": {
				...
				case "TsExprUnary": {
					const unaryExpr = expr as TsExprUnary;
					return TsExprUnary.create(
						unaryExpr.op,
						TsExpr.visit(unaryExpr.expr, f),
					);
				}
				case "TsExprBinaryOp": {
					const binaryExpr = expr as TsExprBinaryOp;
	...
	isLiteral: (expr: TsExpr): expr is TsExprLiteral =>
		expr._tag === "TsExprLiteral",
	isCall: (expr: TsExpr): expr is TsExprCall => expr._tag === "TsExprCall",
	isUnary: (expr: TsExpr): expr is TsExprUnary => expr._tag === "TsExprUnary",
	isBinaryOp: (expr: TsExpr): expr is TsExprBinaryOp =>
		expr._tag === "TsExprBinaryOp",
	isCast: (expr: TsExpr): expr is TsExprCast => expr._tag === "TsExprCast",
	isArrayOf: (expr: TsExpr): expr is TsExprArrayOf =>
		expr._tag === "TsExprArrayOf",
};
...
export const TsEnumMember = {
	...
	withComments: (
		...
		name: TsIdentSimple,
		expr: Option<TsExpr>,
	): TsEnumMember => TsEnumMember.create(comments, name, expr),
	 ...
	 * Type guard
	 */
	isEnumMember: (tree: TsTree): tree is TsEnumMember =>
		tree._tag === "TsEnumMember",
};
...
export const TsTypeConstructor = {
	 ...
	 * Type guard
	 */
	isTypeConstructor: (tpe: TsType): tpe is TsTypeConstructor =>
		tpe._tag === "TsTypeConstructor",
};
...
export const TsTypeAsserts = {
	 ...
	 * Type guard
	 */
	isTypeAsserts: (tpe: TsType): tpe is TsTypeAsserts =>
		tpe._tag === "TsTypeAsserts",
};
...
export const TsTupleElement = {
	 ...
	 */
	unlabeled: (tpe: TsType): TsTupleElement => TsTupleElement.create(none, tpe),
	 ...
	 * Type guard
	 */
	isTupleElement: (tree: TsTree): tree is TsTupleElement =>
		tree._tag === "TsTupleElement",
};
...
export const TsTypeTuple = {
	 ...
	 */
	empty: (): TsTypeTuple => TsTypeTuple.create(IArray.Empty),
...
export const TsTypeRepeated = {
	 ...
	 * Type guard
	 */
	isTypeRepeated: (tpe: TsType): tpe is TsTypeRepeated =>
		tpe._tag === "TsTypeRepeated",
};
...
export const TsTypeLookup = {
	 ...
	 * Type guard
	 */
	isTypeLookup: (tpe: TsType): tpe is TsTypeLookup =>
		tpe._tag === "TsTypeLookup",
};
...
export const TsTypeConditional = {
	 ...
	 * Type guard
	 */
	isTypeConditional: (tpe: TsType): tpe is TsTypeConditional =>
		tpe._tag === "TsTypeConditional",
};
...
export const TsTypeExtends = {
	 ...
	 * Type guard
	 */
	isTypeExtends: (tpe: TsType): tpe is TsTypeExtends =>
		tpe._tag === "TsTypeExtends",
};
...
export const TsMemberTypeMapped = {
	 ...
	 * Type guard
	 */
	isMemberTypeMapped: (tree: TsTree): tree is TsMemberTypeMapped =>
		tree._tag === "TsMemberTypeMapped",
};
...
export const TsTemplatePartLiteral = {
	 ...
	 * Type guard
	 */
	isTemplatePartLiteral: (tree: TsTree): tree is TsTemplatePartLiteral =>
		tree._tag === "TsTemplatePartLiteral",
};
...
export const TsTemplatePartType = {
	 ...
	 * Type guard
	 */
	isTemplatePartType: (tree: TsTree): tree is TsTemplatePartType =>
		tree._tag === "TsTemplatePartType",
};
...
export const TsTypeTemplateLiteral = {
	...
	create: (parts: IArray<TsTemplatePart>): TsTypeTemplateLiteral => ({
		...
		parts,
		asString: `TsTypeTemplateLiteral(\`${parts
			.toArray()
			.map((p) =>
	...
	fromString: (template: string): TsTypeTemplateLiteral => {
		...
		const parts = IArray.fromArray([
			TsTemplatePartLiteral.create(template),
		] as TsTemplatePart[]);
	 ...
	 * Type guard
	 */
	isTypeTemplateLiteral: (tpe: TsType): tpe is TsTypeTemplateLiteral =>
		tpe._tag === "TsTypeTemplateLiteral",
};
