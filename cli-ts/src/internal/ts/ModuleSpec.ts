...
export const ModuleSpec = {
	 ...
	 * Type guards
	 */
	isDefaulted: (spec: ModuleSpec): spec is DefaultedModuleSpec =>
		spec._tag === "Defaulted",
	isNamespaced: (spec: ModuleSpec): spec is NamespacedModuleSpec =>
		spec._tag === "Namespaced",
	isSpecified: (spec: ModuleSpec): spec is SpecifiedModuleSpec =>
		spec._tag === "Specified",
};
