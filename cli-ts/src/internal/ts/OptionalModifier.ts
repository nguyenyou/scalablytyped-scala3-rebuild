...
export const OptionalModifier = {
  ...
  get all(): OptionalModifier[] {
    return [OptionalModifier.noop(), OptionalModifier.optionalize(), OptionalModifier.deoptionalize()];
  },
...
export const DeoptionalizeInstance: Deoptionalize = OptionalModifier.deoptionalize();
