...
export namespace LibScalaJs {
   ...
   */
  export class Unpack {
    static unapply(m: SortedMap<LibTsSource, LibScalaJs>): SortedMap<LibTsSource, LibScalaJs> {
      return Unpack.apply(m);
    }

    static apply(m: SortedMap<LibTsSource, LibScalaJs>): SortedMap<LibTsSource, LibScalaJs> {
