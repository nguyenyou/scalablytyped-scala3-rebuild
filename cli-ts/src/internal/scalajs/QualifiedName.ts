...
export class QualifiedName {
  ...
  static readonly java_lang = new QualifiedName(IArray.fromArray([Name.java, Name.lang]));
  ...
  static readonly isUndefined = QualifiedName.scala_js.add(new Name("isUndefined"));
  static readonly JsDictionary = QualifiedName.scala_js.add(new Name("Dictionary"));
  ...
  static readonly Runtime = new QualifiedName(IArray.fromArray([
    new Name("org"),
    new Name("scalablytyped"),
    new Name("runtime")
  ]));
  static readonly NumberDictionary = QualifiedName.Runtime.add(new Name("NumberDictionary"));
  static readonly StringDictionary = QualifiedName.Runtime.add(new Name("StringDictionary"));
  ...
  static readonly INTERSECTION = new QualifiedName(IArray.fromArray([Name.INTERSECTION]));
  static readonly STRING_LITERAL = new QualifiedName(IArray.fromArray([Name.STRING_LITERAL]));
  static readonly DOUBLE_LITERAL = new QualifiedName(IArray.fromArray([Name.DOUBLE_LITERAL]));
  static readonly INT_LITERAL = new QualifiedName(IArray.fromArray([Name.INT_LITERAL]));
  static readonly BOOLEAN_LITERAL = new QualifiedName(IArray.fromArray([Name.BOOLEAN_LITERAL]));
  static readonly THIS = new QualifiedName(IArray.fromArray([Name.THIS]));
  static readonly WILDCARD = new QualifiedName(IArray.fromArray([Name.WILDCARD]));
  static readonly REPEATED = new QualifiedName(IArray.fromArray([Name.REPEATED]));
  static readonly SINGLETON = new QualifiedName(IArray.fromArray([Name.SINGLETON]));
  static readonly UNDEFINED = new QualifiedName(IArray.fromArray([Name.UNDEFINED]));
...
export class StdNames {
  ...
  constructor(outputPkg: Name) {
    ...
    this.HTMLElementTagNameMap = this.lib.add(new Name("HTMLElementTagNameMap"));
