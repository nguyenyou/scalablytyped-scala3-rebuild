...
import typings.tabulatorTables.tabulatorTablesStrings.headerFilter
...
trait OptionsPersistentConfiguration extends StObject {
  ...
  var persistenceReaderFunc: js.UndefOr[
    js.Function2[
      /* id */ String, 
      /* type */ sort | filter | group | page | columns | headerFilter, 
      Any
    ]
  ] = js.undefined
...
object OptionsPersistentConfiguration {
  ...
  implicit open class MutableBuilder[Self <: OptionsPersistentConfiguration] (val x: Self) extends AnyVal {
    ...
    inline def setPersistenceReaderFunc(value: (/* id */ String, /* type */ sort | filter | group | page | columns | headerFilter) => Any): Self = StObject.set(x, "persistenceReaderFunc", js.Any.fromFunction2(value))
    ...
    inline def setPersistenceWriterFunc(
      value: (/* id */ String, /* type */ sort | filter | group | page | columns | headerFilter, /* data */ Any) => Any
