...
import typings.tabulatorTables.tabulatorTablesStrings.range
...
trait OptionsClipboard extends StObject {
  ...
  /**
    ...
    */
  var clipboardPasteAction: js.UndefOr[insert | update | replace | range] = js.undefined
...
object OptionsClipboard {
  ...
  implicit open class MutableBuilder[Self <: OptionsClipboard] (val x: Self) extends AnyVal {
    ...
    inline def setClipboardPasteAction(value: insert | update | replace | range): Self = StObject.set(x, "clipboardPasteAction", value.asInstanceOf[js.Any])
