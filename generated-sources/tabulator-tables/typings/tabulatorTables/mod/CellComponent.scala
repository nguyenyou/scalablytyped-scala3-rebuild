...
trait CellComponent extends StObject {
  ...
  def getData(): StringDictionary[Any] = js.native
  def getData(transformType: data | download | clipboard): StringDictionary[Any] = js.native
  ...
  def getType(): cell | header = js.native
