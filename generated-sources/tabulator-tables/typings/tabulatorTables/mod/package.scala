...
org.scalajs.dom.HTMLElement | typings.tabulatorTables.tabulatorTablesBooleans.`false`]
*/
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.tabulatorTables.tabulatorTablesStrings.toggle
  - js.Function3[
/ * cell * / typings.tabulatorTables.mod.CellComponent, 
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.tabulatorTables.mod.ToggleSwitchParams
  - js.Function1[/ * cell * / typings.tabulatorTables.mod.CellComponent, js.Object]
*/
...
type GroupArg = String | (js.Array[(js.Function1[/* data */ Any, Any]) | String]) | (js.Function1[/* data */ Any, Any])
...
type HeaderFilterFunc = js.Function4[
/* headerValue */ Any, 
/* rowValue */ Any, 
/* rowData */ Any, 
/* filterParams */ Any, 
