...
trait OptionsMenu extends StObject {
  ...
  var groupClickPopup: js.UndefOr[String] = js.undefined
  
  var groupContextMenu: js.UndefOr[js.Array[MenuObject[GroupComponent]]] = js.undefined
  
  var groupContextPopup: js.UndefOr[String] = js.undefined
  ...
  var groupDblPopup: js.UndefOr[String] = js.undefined
  ...
  var rowClickPopup: js.UndefOr[String] = js.undefined
  
  var rowContextMenu: js.UndefOr[RowContextMenuSignature] = js.undefined
  
  var rowContextPopup: js.UndefOr[String] = js.undefined
...
object OptionsMenu {
  ...
  implicit open class MutableBuilder[Self <: OptionsMenu] (val x: Self) extends AnyVal {
    ...
    inline def setGroupClickMenuFunction2(
      value: (/* e */ MouseEvent, /* component */ GroupComponent) => MenuObject[GroupComponent] | `false` | js.Array[Any]
    ...
    inline def setGroupClickPopup(value: String): Self = StObject.set(x, "groupClickPopup", value.asInstanceOf[js.Any])
    
    inline def setGroupClickPopupUndefined: Self = StObject.set(x, "groupClickPopup", js.undefined)
    ...
    inline def setGroupContextPopup(value: String): Self = StObject.set(x, "groupContextPopup", value.asInstanceOf[js.Any])
    
    inline def setGroupContextPopupUndefined: Self = StObject.set(x, "groupContextPopup", js.undefined)
    ...
    inline def setGroupDblPopup(value: String): Self = StObject.set(x, "groupDblPopup", value.asInstanceOf[js.Any])
    
    inline def setGroupDblPopupUndefined: Self = StObject.set(x, "groupDblPopup", js.undefined)
    ...
    inline def setRowClickPopup(value: String): Self = StObject.set(x, "rowClickPopup", value.asInstanceOf[js.Any])
    
    inline def setRowClickPopupUndefined: Self = StObject.set(x, "rowClickPopup", js.undefined)
    ...
    inline def setRowContextPopup(value: String): Self = StObject.set(x, "rowContextPopup", value.asInstanceOf[js.Any])
    
    inline def setRowContextPopupUndefined: Self = StObject.set(x, "rowContextPopup", js.undefined)
