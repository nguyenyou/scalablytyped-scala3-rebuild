...
trait OptionsPagination extends StObject {
  ...
  var paginationSize: js.UndefOr[Double | `true`] = js.undefined
...
object OptionsPagination {
  ...
  implicit open class MutableBuilder[Self <: OptionsPagination] (val x: Self) extends AnyVal {
    ...
    inline def setPaginationSize(value: Double | `true`): Self = StObject.set(x, "paginationSize", value.asInstanceOf[js.Any])
