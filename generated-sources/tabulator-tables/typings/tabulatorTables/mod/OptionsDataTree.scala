...
trait OptionsDataTree extends StObject {
  ...
  /**
    ...
    */
  var dataTreeChildColumnCalcs: js.UndefOr[Boolean] = js.undefined
...
object OptionsDataTree {
  ...
  implicit open class MutableBuilder[Self <: OptionsDataTree] (val x: Self) extends AnyVal {
    ...
    inline def setDataTreeChildColumnCalcs(value: Boolean): Self = StObject.set(x, "dataTreeChildColumnCalcs", value.asInstanceOf[js.Any])
    
    inline def setDataTreeChildColumnCalcsUndefined: Self = StObject.set(x, "dataTreeChildColumnCalcs", js.undefined)
