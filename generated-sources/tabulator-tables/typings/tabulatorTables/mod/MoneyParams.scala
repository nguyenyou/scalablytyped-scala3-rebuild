...
trait MoneyParams
  ...
  var negativeSign: js.UndefOr[String | `true`] = js.undefined
...
object MoneyParams {
  ...
  implicit open class MutableBuilder[Self <: MoneyParams] (val x: Self) extends AnyVal {
    ...
    inline def setNegativeSign(value: String | `true`): Self = StObject.set(x, "negativeSign", value.asInstanceOf[js.Any])
