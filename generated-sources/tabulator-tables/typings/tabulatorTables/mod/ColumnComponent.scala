...
import typings.tabulatorTables.tabulatorTablesStrings.left
import typings.tabulatorTables.tabulatorTablesStrings.middle
import typings.tabulatorTables.tabulatorTablesStrings.right
...
trait ColumnComponent
  ...
  def scrollTo(position: left | middle | right): js.Promise[Unit] = js.native
  def scrollTo(position: left | middle | right, scrollIfVisible: Boolean): js.Promise[Unit] = js.native
