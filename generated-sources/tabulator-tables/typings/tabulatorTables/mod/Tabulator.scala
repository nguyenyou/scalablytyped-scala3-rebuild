...
import typings.tabulatorTables.anon.Instantiable
import typings.tabulatorTables.tabulatorTablesBooleans.`false`
import typings.tabulatorTables.tabulatorTablesBooleans.`true`
import typings.tabulatorTables.tabulatorTablesStrings.binary
import typings.tabulatorTables.tabulatorTablesStrings.buffer
...
import typings.tabulatorTables.tabulatorTablesStrings.text
import typings.tabulatorTables.tabulatorTablesStrings.url
...
open class Tabulator protected () extends StObject {
  ...
  def activeSheet(lookup: String): Unit = js.native
  def activeSheet(lookup: SpreadsheetComponent): Unit = js.native
  ...
  /**
    ...
    */
  def addRange(topLeft: CellComponent, bottomRight: CellComponent): RangeComponent = js.native
  ...
  def addSheet(data: SpreadsheetSheet): Unit = js.native
  ...
  def clearSheet(lookup: String): Unit = js.native
  def clearSheet(lookup: SpreadsheetComponent): Unit = js.native
  ...
  def deleteRow(index: js.Array[RowLookup]): js.Promise[Unit] = js.native
  /** You can delete any row in the table using the deleteRow function. */
  def deleteRow(index: RowLookup): js.Promise[Unit] = js.native
  
  def deselectRow(): Unit = js.native
  def deselectRow(row: js.Array[RowLookup]): Unit = js.native
  ...
  def getPageSize(): Double | `true` = js.native
  ...
  /**
    ...
    */
  def getRanges(): js.Array[RangeComponent] = js.native
  ...
  /**
    ...
    * ```
    */
  def getRangesData(): js.Array[js.Array[Any]] = js.native
  ...
  def getSheet(lookup: String): SpreadsheetComponent = js.native
  def getSheet(lookup: SpreadsheetComponent): SpreadsheetComponent = js.native
  
  def getSheetData(lookup: String): js.Array[js.Array[Any]] = js.native
  def getSheetData(lookup: SpreadsheetComponent): js.Array[js.Array[Any]] = js.native
  
  def getSheetDefinitions(): js.Array[SpreadsheetSheet] = js.native
  
  def getSheets(): js.Array[SpreadsheetComponent] = js.native
  ...
  /**
    ...
    */
  def `import`(data: Any, `extension`: String): Any = js.native
  def `import`(data: Any, `extension`: String, format: buffer | binary | url | text): Any = js.native
  def `import`(data: Any, `extension`: js.Array[String]): Any = js.native
  def `import`(data: Any, `extension`: js.Array[String], format: buffer | binary | url | text): Any = js.native
  ...
  def off[K /* <: /* keyof tabulator-tables.tabulator-tables.EventCallBackMethods */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 125, starting with typings.tabulatorTables.tabulatorTablesStrings.validationFailed, typings.tabulatorTables.tabulatorTablesStrings.scrollHorizontal, typings.tabulatorTables.tabulatorTablesStrings.scrollVertical */ Any */](event: K): Unit = js.native
  ...
  def on[K /* <: /* keyof tabulator-tables.tabulator-tables.EventCallBackMethods */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 125, starting with typings.tabulatorTables.tabulatorTablesStrings.validationFailed, typings.tabulatorTables.tabulatorTablesStrings.scrollHorizontal, typings.tabulatorTables.tabulatorTablesStrings.scrollVertical */ Any */](event: K): Unit = js.native
  def on[K /* <: /* keyof tabulator-tables.tabulator-tables.EventCallBackMethods */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 125, starting with typings.tabulatorTables.tabulatorTablesStrings.validationFailed, typings.tabulatorTables.tabulatorTablesStrings.scrollHorizontal, typings.tabulatorTables.tabulatorTablesStrings.scrollVertical */ Any */](
    event: K,
    callback: /* import warning: importer.ImportType#apply Failed type conversion: tabulator-tables.tabulator-tables.EventCallBackMethods[K] */ js.Any
  ): Unit = js.native
  ...
  def removeSheet(lookup: String): Unit = js.native
  def removeSheet(lookup: SpreadsheetComponent): Unit = js.native
  ...
  def selectRow(lookup: RowLookup): Unit = js.native
  ...
  def setData(): js.Promise[Unit] = js.native
  ...
  def setData(data: Unit, params: Any): js.Promise[Unit] = js.native
  def setData(data: Unit, params: Any, config: Any): js.Promise[Unit] = js.native
  def setData(data: Unit, params: Unit, config: Any): js.Promise[Unit] = js.native
  ...
  @JSName("setPageSize")
  def setPageSize_true(size: `true`): Unit = js.native
  ...
  def setSheetData(lookup: String, data: js.Array[js.Array[Any]]): Unit = js.native
  def setSheetData(lookup: SpreadsheetComponent, data: js.Array[js.Array[Any]]): Unit = js.native
  
  def setSheets(data: js.Array[SpreadsheetSheet]): Unit = js.native
...
object Tabulator {
  ...
  @js.native
  def registerModule: js.Function1[/* modules */ Instantiable | js.Array[Instantiable], Unit] = js.native
  inline def registerModule_=(x: js.Function1[/* modules */ Instantiable | js.Array[Instantiable], Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("registerModule")(x.asInstanceOf[js.Any])
}
