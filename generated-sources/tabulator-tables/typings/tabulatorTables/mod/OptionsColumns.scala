...
import typings.tabulatorTables.tabulatorTablesStrings.full
...
trait OptionsColumns extends StObject {
  ...
  var autoColumns: js.UndefOr[Boolean | full] = js.undefined
  
  var autoColumnsDefinitions: js.UndefOr[
    (js.Function1[
      /* columnDefinitions */ js.UndefOr[js.Array[ColumnDefinition]], 
      js.Array[PartialColumnDefinition]
    ]) | js.Array[PartialColumnDefinition] | (Record[String, PartialColumnDefinition])
  ] = js.undefined
  ...
  var columnDefaults: js.UndefOr[PartialColumnDefinition] = js.undefined
...
object OptionsColumns {
  ...
  implicit open class MutableBuilder[Self <: OptionsColumns] (val x: Self) extends AnyVal {
    ...
    inline def setAutoColumns(value: Boolean | full): Self = StObject.set(x, "autoColumns", value.asInstanceOf[js.Any])
    ...
    inline def setAutoColumnsDefinitionsFunction1(
      value: /* columnDefinitions */ js.UndefOr[js.Array[ColumnDefinition]] => js.Array[PartialColumnDefinition]
    ...
    inline def setAutoColumnsDefinitionsVarargs(value: PartialColumnDefinition*): Self = StObject.set(x, "autoColumnsDefinitions", js.Array(value*))
    ...
    inline def setColumnDefaults(value: PartialColumnDefinition): Self = StObject.set(x, "columnDefaults", value.asInstanceOf[js.Any])
    ...
    inline def setResizableColumnFit(value: Boolean): Self = StObject.set(x, "resizableColumnFit", value.asInstanceOf[js.Any])
    
    inline def setResizableColumnFitUndefined: Self = StObject.set(x, "resizableColumnFit", js.undefined)
