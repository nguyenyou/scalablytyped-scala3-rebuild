...
import typings.tabulatorTables.tabulatorTablesStrings.csv
...
trait OptionsData extends StObject {
  ...
  var importFormat: js.UndefOr[array | csv | json | (js.Function1[/* fileContents */ String, js.Array[Any]])] = js.undefined
  ...
  var importReader: js.UndefOr[binary | buffer | text | url] = js.undefined
...
object OptionsData {
  ...
  implicit open class MutableBuilder[Self <: OptionsData] (val x: Self) extends AnyVal {
    ...
    inline def setImportFormat(value: array | csv | json | (js.Function1[/* fileContents */ String, js.Array[Any]])): Self = StObject.set(x, "importFormat", value.asInstanceOf[js.Any])
    
    inline def setImportFormatFunction1(value: /* fileContents */ String => js.Array[Any]): Self = StObject.set(x, "importFormat", js.Any.fromFunction1(value))
    
    inline def setImportFormatUndefined: Self = StObject.set(x, "importFormat", js.undefined)
    
    inline def setImportReader(value: binary | buffer | text | url): Self = StObject.set(x, "importReader", value.asInstanceOf[js.Any])
    
    inline def setImportReaderUndefined: Self = StObject.set(x, "importReader", js.undefined)
