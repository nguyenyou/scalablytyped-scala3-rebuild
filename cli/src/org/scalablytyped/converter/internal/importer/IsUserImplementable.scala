...
/** This is a heuristic.
  ...
  *
  * For the latter, we want to provide different ways of instantiating an instance of the structure, either through
  * mutable builders or `@ScalaJSDefined` traits.
  */
