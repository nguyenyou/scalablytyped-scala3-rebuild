...
/** A mapping from one javascript type to another.
  *
  * @param from
  *   typically from ScalablyTyped
  * @param to
  *   typically from the library you want to convert into
  * @param tparams
  *   Since the set of type parameters might differ you can pick among the provided type arguments in the `from` type
  */
